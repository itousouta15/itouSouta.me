...
export const EXPERIENCE: ExperienceItem[] = [
  ...
  },
  {
    ...
    category: "社群",
    longDesc:
      "中文全名為中部電資聯合會議，簡稱「中電會」。成立於 2022 年 2 月，由文華高中電腦研究社第 29 屆社長周佑康與臺中一中數位創作社第 16 屆社長蔡承希，在 AIS3 新型態資安實務主題課程講師——台科大鄭欣明教授與陽交大黃俊穎教授——的啟發下共同創立。我們的目標是結合中部電資資源，打造一個跨校交流、合作學習的資訊教育平台，以積極辦理資訊教育活動、促進資源共享與永續傳承為宗旨",
